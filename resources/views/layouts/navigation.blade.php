<nav x-data="{ open: false }" class="bg-white ">
                ...
                @auth
                    @if (!Auth::user()->admin)
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex text-black">
                            <x-nav-link :href="route('userDashboard')" :active="request()->routeIs('userDashboard', 'festival.info')">
                                {{ __('Festivals') }}
                            </x-nav-link>
                        </div>
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex text-black">
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                ...
                                @if (!Auth::user()->admin)
                                    <div class="mr-2 ml-3">
                                        <p class="font-bold">{{ Auth::user()->points }} Pts</p>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('userDashboard')" :active="request()->routeIs('dashboard')">
                {{ __('Dashboard') }}
